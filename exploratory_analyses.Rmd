...
On this page, you will find exploratory analyses of the predictors and outcomes for our linear models. Predictors described here include *Female Secondary School Enrollment Rates* and *Total Number of Complex Emergencies*. Outcomes include *Total Fertility Rates* and *Net Reproductive Rates*.
...
fertility_nrr %>% 
  plot_ly(
   ...
   layout(
    ...
    xaxis = list(title = "Year"),
    yaxis = list(title = "Net Reproductive Rate (NRR)"),
    showlegend = TRUE, 
    legend = list(font = list(size = 10))
    )
```
This plot illustrates changes in net reproductive rates in Southeast Asian countries, relative to global estimates, over time (1980 - 2010). 

Within this time period, ASEAN net reproductive rates appeared to mirror global net reproduction rates and declined over time. Cambodia, Lao PDR, Philippines, and Myanmar maintained net reproduction rates that consistently exceeded global estimates. Conversely, Thailand and Singapore had net reproduction rates that were consistently below global estimates. 

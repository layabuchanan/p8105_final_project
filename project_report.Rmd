...
Unlike total fertility rates and net reproductive rates over time, female secondary enrollment rates followed an upward trend during this 30-year time span. 
...
To create maps exploring spatial and temporal trends for both total fertility rates and secondary school enrollment rates in Southeast Asia from 1980 to 2010, the dataframe used for exploratory analysis and linear models was separated into three dataframes, one for each decade. Each of these were merged with a shapefile from Esri that contained information on country geometry and projections for mapping. Secondary school enrollment rates and total fertility rates were visualized as  choropleth maps separately by decade. Generally, countries with high fertility rates had lower secondary school enrollment rates, and over time, secondary school enrollment rates increased while total fertility rates decreased over the course of the three decades.
...
Null Hypothesis: The effect of female secondary school enrollment is not significantly related to net reproductive rate, adjusting for relative level of complex emergencies.

Alternative Hypothesis: The effect of female secondary school enrollment is significantly related to net reproductive rate, adjusting for relative level of complex emergencies.
...
http://ghdx.healthdata.org/record/ihme-data/gbd-2019-fertility-estimates-1950-2019

https://www.who.int/environmental_health_emergencies/complex_emergencies/en/#:~:text=Complex%20emergencies%20are%20situations%20of,difficult%20political%20and%20security%20environment.

https://www.indexmundi.com/facts/indicators/SE.SEC.NENR.FE#:~:text=Indicators%20%3E%20Education%20%3E%20Participation-,School%20enrollment%2C%20secondary%2C%20female%20(%25%20net),the%20corresponding%20official%20school%20age.
